    ...
    <div className={cn("flex flex-col sm:flex-row items-center justify-between gap-4 px-2 py-4", className)}>
      ...
      <div className="flex items-center gap-2 order-1 sm:order-2">
        <button
          ...
          className="p-2 rounded-full border border-neutral-200 bg-white text-neutral-400 hover:bg-neutral-50 hover:text-neutral-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all shadow-sm active:scale-95"
          title="First Page"
        >
        ...
        <div className="px-5 py-2.5 rounded-full bg-neutral-900 text-white text-[11px] font-black shadow-lg shadow-neutral-900/20 min-w-[70px] text-center tracking-[0.1em]">
          {pageIndex + 1} <span className="text-neutral-500 mx-1">/</span> {Math.max(1, pageCount)}
        </div>
