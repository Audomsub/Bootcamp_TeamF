    ...
    <div className="min-h-screen mesh-bg flex flex-col lg:flex-row overflow-hidden">
      ...
      >
        ...
        <div className="h-32 flex flex-col justify-center px-10">
          <div className="flex items-center gap-4 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-black tracking-[0.3em] text-primary-400 uppercase mt-1.5">ระบบจัดการส่วนกลาง</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
        ...
        <div className="px-10 mb-8">
          <div className="h-px w-full bg-gradient-to-r from-white/40 to-transparent"></div>
        </div>

        {/* Navigation - Elite High-Contrast Look */}
        <nav className="flex-1 px-5 space-y-1.5 overflow-y-auto custom-scrollbar pt-4">
          <div className="px-6 mb-6">
            <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] leading-none mb-1">เมนูการจัดการ</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="text-xs font-black text-primary-400 truncate tracking-tight">{user?.name || 'Administrator'}</p>
