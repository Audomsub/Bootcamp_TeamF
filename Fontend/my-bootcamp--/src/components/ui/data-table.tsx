                  ...
                  {headerGroup.headers.map((header) => {
                    ...
                    return (
                      <th
                        key={header.id}
                        className={cn(
                          'px-6 py-4 text-xs font-black text-neutral-900 dark:text-neutral-900 uppercase tracking-widest transition-colors',
                          alignClass,
            ...
            <tbody className="divide-y divide-neutral-100">
              {table.getRowModel().rows.length === 0 ? (
                ...
                table.getRowModel().rows.map((row) => (
                  <tr key={row.id} className="group hover:bg-neutral-50/80 transition-all duration-300">
